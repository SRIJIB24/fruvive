...
<head>
    ...
    <title>Seasonal Fruits - Fruvive</title>
...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200 min-h-screen transition-colors duration-300">
    ...
    <div class="main flex flex-col min-h-screen">
        ...
        <div class="text-center py-12 px-4 bg-gradient-to-b from-green-50/50 to-transparent dark:from-green-950/20">
            <h1 class="text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight sm:text-5xl">Seasonal Fruits</h1>
            <p class="max-w-2xl mx-auto mt-3 text-base text-gray-500 dark:text-gray-400">Freshly harvested organic seasonal specialties, direct from local farms.</p>
        </div>
