...
<head>
    ...
    <title>Create Account - Fruvive</title>
    ...
    <div class="w-full flex">
        ...
        <div class="hidden lg:flex lg:w-3/5 bg-gradient-to-tr from-green-800 via-emerald-800 to-teal-900 relative items-center justify-center p-12 overflow-hidden">
            ...
            <div class="max-w-md w-full text-white space-y-8 z-10">
                ...
                <div class="space-y-4">
                    <h2 class="text-3xl font-bold leading-tight">Start Your Wellness Journey.</h2>
                    <p class="text-green-100 text-sm leading-relaxed">
                        Create an account to save delivery addresses, order fresh organic baskets, and track your purchases seamlessly. Your journey to healthy nutrition starts here.
                    </p>
                </div>
        ...
        <div class="w-full lg:w-2/5 flex items-center justify-center p-8 bg-white">
            <div class="max-w-md w-full space-y-8">
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-500">Sign up in seconds to start ordering fresh.</p>
                </div>
                ...
                <form method="POST" class="mt-8 space-y-6">
                    ...
                    <!-- Username Input -->
                    <div class="space-y-2">
                        <label for="nm" class="text-sm font-semibold text-gray-700">Username</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400">
                                <span class="material-icons text-lg">person</span>
                            </span>
                            <input type="text" name="nm" id="nm" required placeholder="Enter Username"
                ...
                <div class="text-center pt-2">
                    <p class="text-sm text-gray-500">
                        ...
                        <a href="login.php" class="font-bold text-green-600 hover:underline">Sign In</a>
                    </p>
                </div>
            </div>
        </div>
